...
/* harmony import */ var _components_scroll_smoth_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/scroll-smoth.js */ "./src/js/components/scroll-smoth.js");
...
var swipersNew = document.querySelectorAll('.project__swiper');
swipersNew.forEach(function (el) {
  var swiperNew = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
    breakpoints: {
...
var rules = [{
  ...
  rules: [{
    rule: 'required',
    value: true,
    errorMessage: 'Заполните текстовое поле!'
  }]
}];
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contact-form', rules, afterForm);
